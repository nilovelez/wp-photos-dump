...
try {
    ...
    $stmt = $db->query("SELECT id, slug FROM photos WHERE categories IS NULL ORDER BY id");
...
<html>
<head>
    <title>WordPress Photos Dump - Empty Categories</title>
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <h2>Photos Without Categories</h2>
            ...
            <?php else: ?>
                ...
                <div class='processing-summary'>
                    <p>Total photos without categories: <?php echo count($photos); ?></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
