...
try {
    ...
    $stmt = $db->query("SELECT id, slug FROM photos WHERE tags IS NULL ORDER BY id");
...
<html>
<head>
    <title>WordPress Photos Dump - Empty Tags</title>
        ...
        <div class='content'>
            ...
            <?php else: ?>
                ...
                <div class='processing-summary'>
                    <p>Total photos without tags: <?php echo count($photos); ?></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
